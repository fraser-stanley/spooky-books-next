 ...
 */
export function adaptSanityCategories(sanityCategories: SanityCategory[]): string[] {
 ...
 */
export function getCategorySlug(categoryTitle: string, sanityCategories: SanityCategory[]): string | null {
