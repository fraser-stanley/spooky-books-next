...
export async function POST() {
  try {
    ...
    console.log(`Found ${products.length} products with old fields to clean up`)
...
export async function GET() {
  return NextResponse.json({
    message: 'POST to this endpoint to clean up old productType and vendor fields from products'
  })
}