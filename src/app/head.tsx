...
export default function Head() {
    return (
      <>
        ...
        <meta name="description" content="Independent publisher of limited edition artists books." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="theme-color" content="#ffffff" />
  
        {/* Open Graph */}
        <meta property="og:title" content="Spooky Books" />
        <meta property="og:description" content="Independent publisher of limited edition artists books." />
        ...
        <meta name="twitter:description" content="Independent publisher of limited edition artists books." />
