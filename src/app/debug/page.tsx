    ...
    return (
      <div className="p-8 max-w-6xl">
          ...
          <div className="grid gap-4">
            {productsWithStock.map((product) => (
              ...
              >
                ...
                {product.variantStockInfo &&
                  product.variantStockInfo.length > 0 && (
                    <div className="mt-4">
                      ...
                      <div className="grid gap-2">
                        {product.variantStockInfo.map((variant) => (
                          ...
                          >
                            ...
                            <span className="ml-2">
                              Status: {variant.stockStatus || "IN STOCK"}
                            </span>
                          </div>
                        ))}
                      </div>
        ...
        <details className="mb-8">
          <summary className="text-xl cursor-pointer mb-4">
            Raw Product Data
          </summary>
